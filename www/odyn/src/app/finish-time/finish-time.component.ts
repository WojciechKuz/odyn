...
export class FinishTimeComponent {
  ...
  tickTock() {
    ...
    (60 - this.date.getMinutes() < 10) ?
    this.minutes.nativeElement.innerText = "0" + (59 - this.date.getMinutes()) :
    this.minutes.nativeElement.innerText = 59 - this.date.getMinutes();

    (60 - this.date.getSeconds() < 10) ?
    this.seconds.nativeElement.innerText = "0" + (59 - this.date.getSeconds()) :
